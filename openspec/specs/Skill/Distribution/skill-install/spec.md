...
Provide Agent-executable installation instructions via README files, covering platform detection, GitHub Release download, deployment to skill directories, and post-install verification.
